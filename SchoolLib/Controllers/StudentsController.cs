...
namespace SchoolLib.Controllers
{
	public class StudentsController : Controller
	{
		...
		private readonly IFormatProvider culture = new CultureInfo("uk-UA");
		...
		(
			[Bind(
				"Id,FirstName,SurName,Patronimic,Street,House,Apartment,Grade,FirstRegistrationDate,LastRegistrationDate,Note")]
			Student student
		)
		{
		...
		(
			int curId,
			[Bind(
				"Id,FirstName,SurName,Patronimic,Street,House,Apartment,Grade,FirstRegistrationDate,LastRegistrationDate,Status,Note")]
			Student student
		)
		{
			if (curId != student.Id)
