...
namespace SchoolLib.Controllers
{
	public class StudyBooksController : Controller
	{
		...
		public async Task<IActionResult> Details(int? id)
		{
			...
			{
				ViewData["readerId"] =
					_context.Issuances.Where(i => i.BookId == studyBook.Id && i.AcceptanceDate == null).SingleOrDefaultAsync()?.Result
						.ReaderId;
			}
		...
		public async Task<IActionResult> Create(
			[Bind("Id,Name,Author,AuthorCipher,Grade,Subject,Published,Price,Note")] StudyBook studyBook
		)
		{
		...
		public async Task<IActionResult> Edit(
			int curId,
			[Bind("Id,Name,Author,AuthorCipher,Grade,Subject,Published,Price,Note,Status")] StudyBook studyBook
		)
		{
