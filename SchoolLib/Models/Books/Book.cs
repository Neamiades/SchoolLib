...
namespace SchoolLib.Models.Books
{
	...
	{
		[Display(Name = "В бібліотеці")] InStock = 1,
		[Display(Name = "У читача")] OnHands = 2,
		[Display(Name = "Будь-який")] Any = InStock | OnHands
	}
	...
	public abstract class Book
	{
		...
		[RegularExpression(@"\d+(\.\d{1,2})?", ErrorMessage =
			"Ціна повинна мати формат Ч[ЧЧ].Ч[Ч] (Ч - число, [] - необов'язковий параметр)")]
