...
namespace SchoolLib.Controllers
{
	public class ReadersController : Controller
	{
		...
		private readonly List<SelectListItem> _readerStatusDropdownList;
		private readonly List<SelectListItem> _readerTypeDropdownList;
			...
			string actn)
		{
			...
			ViewData["type"] = type == "Reader" ? typeof(Reader) : type == "Student" ? typeof(Student) : typeof(Worker);
			if (actn == "activate")
			{
		...
		public async Task<IActionResult> Details(int? id)
		{
			...
			if (reader.Discriminator == "Student")
			{
		...
		public async Task<IActionResult> Edit(int? id)
		{
			...
			if (reader.Discriminator == "Student")
			{
				return RedirectToAction("Edit", "Students", new {id});
			}

			return RedirectToAction("Edit", "Workers", new {id});
		}
		...
		public async Task<IActionResult> Delete(int? id)
		{
			...
			if (reader.Discriminator == "Student")
			{
				return RedirectToAction("Delete", "Students", new {id});
			}

			return RedirectToAction("Delete", "Workers", new {id});
		}
