...
namespace SchoolLib.Controllers
{
	public class BooksStatisticController : Controller
	{
		...
		private readonly List<SelectListItem> bookStatusDropdownList = new List<SelectListItem>();
		private readonly List<SelectListItem> bookTypeDropdownList = new List<SelectListItem>();
		...
		public BooksStatisticController(ApplicationDbContext context)
		{
			...
			bookTypeDropdownList.Add(new SelectListItem
			{
				Text = "Додаткова література",
				Value = "AdditionalBook",
				Selected = false
			});
